package net.es.oscars.pce.tce.common;

import static java.util.Arrays.asList;

import net.es.oscars.logging.OSCARSNetLogger;
import net.es.oscars.pce.tce.TcePCEServer;
...
public class Invoker {
    ...
    public static void main(String[] args) throws Exception {
        ...
        parseArgs( args );
        System.out.println("starting tcePCE service  with context " + context);
        ...
        TcePCEServer server = new TcePCEServer();
        server.startServer(false);
        log.info(netLogger.end("invoker","tce PCE server has started with context: " + context));
